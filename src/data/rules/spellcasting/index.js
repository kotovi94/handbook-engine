export const spellcastingRules = {
  preparationByClass: {
    ...
    cleric: {
      ...
      sourceLabel: "Lista completa de Clérigo",
      helper: "El Clérigo tiene acceso a toda su lista disponible y elige estos conjuros al terminar cada descanso largo.",
    },
    druid: {
      changeWhen: "long-rest",
      changeLabel: "Al terminar descanso largo",
    ...
    paladin: {
      ...
      changeLabel: "Al terminar descanso largo",
      countLabel: "1 conjuro",
      selectionLabel: "Preparados de Paladín",
      sheetLabel: "Preparados de Paladín",
      sourceLabel: "Lista de Paladín",
      helper: "El Paladín prepara una lista fija, pero al terminar un descanso largo puede reemplazar 1 conjuro preparado por otro de la lista de Paladín para el que tenga espacios.",
    },
    ranger: {
      changeWhen: "long-rest",
      changeLabel: "Al terminar descanso largo",
    ...
    "arcane-trickster": {
      ...
      helper: "El Tramposo arcano prepara conjuros de Mago de nivel 1 a nivel 5. Puede reemplazar 1 conjuro preparado al subir de nivel de Pícaro.",
    },
    sorcerer: {
      changeWhen: "gain-level",
      changeLabel: "Al subir de nivel",
    ...
    artificer: {
      ...
      countLabel: "Cualquier cantidad",
      selectionLabel: "Preparados hoy",
      sheetLabel: "Preparados de Artífice",
      sourceLabel: "Lista completa de Artífice",
      helper: "El Artífice tiene acceso a su lista de Artífice disponible y elige estos conjuros al terminar cada descanso largo. Sus conjuros usan herramientas competentes como foco.",
    },
    wizard: {
      changeWhen: "long-rest",
      changeLabel: "Al terminar descanso largo",
  ...
  universalRules: [
    ...
    },
    {
      id: "rituals",
      label: "Rituales",
      sheetText: "Un ritual tarda 10 minutos más y no gasta espacio; para Mago basta que este en el grimorio gracias a Adepto ritual.",
    },
    {
      id: "higher-slot",
    ...
    },
    {
      id: "concentration",
      label: "Concentración",
      sheetText: "Si un conjuro requiere concentración y la pierdes, el conjuro termina o falla si aún lo estabas lanzando.",
    },
    {
      id: "clear-path",
      label: "Camino claro",
    ...
    },
    {
      ...
      sheetText: "Efectos de conjuros distintos se combinan; el mismo conjuro no se acumula, aplica el más potente o reciente.",
    },
  ],
  formulas: {
    saveDc: "8 + modificador de aptitud mágica + bonificador por competencia",
    attackBonus: "modificador de aptitud mágica + bonificador por competencia",
  },
  schools: [
    ...
    { id: "Divination", label: "Adivinacion", summary: "Revela información." },
    { id: "Enchantment", label: "Encantamiento", summary: "Influye en mentes." },
    { id: "Evocation", label: "Evocación", summary: "Canaliza energía, a menudo destructiva." },
    { id: "Illusion", label: "Ilusión", summary: "Engana sentidos o mente." },
