...
const animalCatalog = [
  ...
  { name: "aranas pequeñas", ref: "Spider / Swarm of Insects", tier: "minor", tags: ["swarm", "climb", "underground"], role: "veneno menor, telaranas y terreno incomodo" },
  ...
  { name: "murcielagos gigantes", ref: "Giant Bat", tier: "low", tags: ["flying", "cave", "underground"], role: "ataque desde techo y retirada rápida" },
  ...
  { name: "escorpiones gigantes", ref: "Giant Scorpion", tier: "standard", tags: ["poison", "guardian", "underground"], role: "pinzas, veneno y guardian de cámara" },
...
const animalBehaviorNotes = [
  ...
  "Si son muchas criaturas pequeñas, tratalas como presion y no como duelo largo.",
